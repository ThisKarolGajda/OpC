...
public class InvHolderImpl {
    private final InvHolder<?> holder;
    private final INVENTORY_HOLDER_TYPE type;
    private final InventoryActionManager manager;

    public InvHolderImpl(InvHolder<?> holder, INVENTORY_HOLDER_TYPE type, InventoryEventHolder closeAction) {
        this.holder = holder;
        this.type = type;
        this.manager = new InventoryActionManager(this, closeAction);
    }

    public InvHolderImpl(@NotNull INVENTORY_HOLDER_TYPE type, AbstractInventory<?, ?> inventory, InventoryEventHolder closeAction) {
        if (type.equals(INVENTORY_HOLDER_TYPE.DEFAULT)) {
            this.holder = new DefaultInvHolder((AbstractInventory<Integer, InventoryItem>) inventory);
        } else {
            this.holder = new PagedInvHolder((AbstractInventory<Integer, InventoryPage<Integer, InventoryItem>>) inventory);
        }
        this.type = type;
        this.manager = new InventoryActionManager(this, closeAction);
    }

    public InvHolderImpl(DefaultInvHolder holder, InventoryEventHolder closeAction) {
        this.holder = holder;
        this.type = INVENTORY_HOLDER_TYPE.DEFAULT;
        this.manager = new InventoryActionManager(this, closeAction);
    }

    public InvHolderImpl(PagedInvHolder holder, InventoryEventHolder closeAction) {
        this.holder = holder;
        this.type = INVENTORY_HOLDER_TYPE.PAGED;
        this.manager = new InventoryActionManager(this, closeAction);
    }

    public InvHolderImpl(AbstractInventory<Integer, InventoryItem> inventory, InventoryEventHolder closeAction) {
        this(new DefaultInvHolder(inventory), closeAction);
    }

    public InvHolder<?> getHolder() {
        return holder;
    }

    public DefaultInvHolder getDefaultHolder() {
        return (DefaultInvHolder) holder;
    }

    public PagedInvHolder getPagedHolder() {
        return (PagedInvHolder) holder;
    }
