...
public class DefaultTeleportSettings extends TeleportSettings {
    ...
    private static final TeleportSettingsVisual onInvalid = new TeleportSettingsVisual("Place where you wanted to teleported is unsafe!", null, new OpSound(Sound.ENTITY_GOAT_HORN_BREAK).setVolume(1.5f), new OpTitle("Not safe!", "You cannot teleport there!", 10, 80, 10));
